...
static NSString * _Nonnull PW_TableName = @"wallet_dappFavorites";

@implementation PW_DappFavoritesManager

+ (instancetype)shared {
    static PW_DappFavoritesManager *sharedInstance = nil;
