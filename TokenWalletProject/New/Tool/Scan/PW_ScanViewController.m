...
@interface PW_ScanViewController ()

@end

@implementation PW_ScanViewController
    ...
    switch (_libraryType) {
        case PW_SLT_Native:
        {
            ...
            if (!_scanObj )
            {
                ...
                if (_scanCodeType != PW_SCT_BarCodeITF ) {
...
//            return ZBAR_QRCODE;
//            break;
//        case PW_SCT_BarCode93:
//            return ZBAR_CODE93;
//            break;
//        case PW_SCT_BarCode128:
//            return ZBAR_CODE128;
//            break;
//        case PW_SCT_BarEAN13:
//            return ZBAR_EAN13;
//            break;
//
//        default:
...
- (NSString*)nativeCodeWithType:(PW_SCANCODETYPE)type
{
    switch (type) {
        case PW_SCT_QRCode:
