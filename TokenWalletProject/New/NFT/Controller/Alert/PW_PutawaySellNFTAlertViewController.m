//
//  PW_PutawaySellNFTAlertViewController.m
//  TokenWalletProject
//
...
@interface PW_PutawaySellNFTAlertViewController ()
...
@implementation PW_PutawaySellNFTAlertViewController
...
- (void)sureAction {
    ...
    vc.titleStr = LocalizedStr(@"text_confirmSell");
    vc.descStr = PW_StrFormat(LocalizedStr(@"text_putawaySellTip"),@"0.01ETH");
...
- (void)makeViews {
    ...
    UILabel *titleLb = [PW_ViewTool labelSemiboldText:LocalizedStr(@"text_putawaySell") fontSize:15 textColor:[UIColor g_textColor]];
