...
- (void)initDefaults{
    ...
    self.layer.borderColor = COLOR_BROWN.CGColor;
    self.layer.borderWidth = 1;
    self.btnTitleNormalColor = BG_WHITE;
    self.btnTitleSelectColor = BG_WHITE;
    self.btnBackgroundNormalColor = BG_BlACK;
    self.btnBackgroundSelectColor = COLOR_BROWN;
