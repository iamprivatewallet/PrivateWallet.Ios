...
- (void)configureProperty
{
    ...
    _buttonContentViewEdge = 0;
    _buttonContentViewTop = kContentViewSpace;
    _buttonCornerRadius = 4.0;
    _buttonFont = [UIFont systemFontOfSize:16];
    _buttonDefaultBgColor = [UIColor colorWithRed:188/255.0 green:152/255.0 blue:115/255.0 alpha:1];
    _buttonCancelBgColor = [UIColor colorWithRed:191/255.0 green:191/255.0 blue:191/255.0 alpha:1];
    _buttonDestructiveBgColor = [UIColor colorWithRed:188/255.0 green:152/255.0 blue:115/255.0 alpha:1];
    ...
    _textFieldBorderColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1];
...
- (void)addTextLabels
{
    ...
    titleLabel.font = Set_Font(@"Medium", 18);
...
- (void)addTextFieldWithConfigurationHandler:(void (^)(UITextField *textField))configurationHandler
{
    ...
    if ([_titleLable.text isEqualToString:@"请输入有效的节点地址"]) {
        textField.text = @"http://";
    }
    if ([_titleLable.text isEqualToString:@"请输入指定金额"]) {
        [textField addTarget:self action:@selector(edtiting:) forControlEvents:UIControlEventEditingChanged];
    }
...
-(void)edtiting:(UITextField *)sender{
    [UITools editing:8 textfield:sender];
}
