...
- (void)updateSubviewsFrame
{
    ...
    if (CGRectEqualToRect(self.collectionViewFrame, CGRectZero)) {
...
- (UIPageControl *)pageControl
{
    if (!_pageControl) {
        ...
        _pageControl.userInteractionEnabled = NO;
        _pageControl.autoresizingMask = UIViewAutoresizingNone;
        _pageControl.pageIndicatorTintColor = COLOR_HEX(@"#d8d8d8");
        _pageControl.currentPageIndicatorTintColor = COLOR_HEX(@"#000000");
    }
    return _pageControl;
}
...
-(void)setCollectionViewFrame:(CGRect)collectionViewFrame
{
    _collectionViewFrame = collectionViewFrame;
