...
//    _ringtLineView.hidden = YES;
    _ringtLineView.frame = CGRectMake(CGRectGetMaxX(_LeftTitleLabel.frame) + 5, _LeftTitleLabel.center.y, self.bounds.size.width - CGRectGetMaxX(_LeftTitleLabel.frame) - 5, 1);
...
-(void)setYValue:(NSString *)yValue suffix:(NSString *)suffix withUIConfgi:(YKUIConfig *)config{
    ...
    _ringtLineView.hidden = _ishidden;
